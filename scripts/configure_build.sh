...
export CUDAQ_INSTALL_PREFIX=${CUDAQ_INSTALL_PREFIX:-$PREREQ_INSTALL_ROOT/cudaq}
export CUQUANTUM_INSTALL_PREFIX=${CUQUANTUM_INSTALL_PREFIX:-$PREREQ_INSTALL_ROOT/cuquantum}
export CUTENSOR_INSTALL_PREFIX=${CUTENSOR_INSTALL_PREFIX:-$PREREQ_INSTALL_ROOT/cutensor}
export LLVM_INSTALL_PREFIX=${LLVM_INSTALL_PREFIX:-$PREREQ_INSTALL_ROOT/llvm}
export BLAS_INSTALL_PREFIX=${BLAS_INSTALL_PREFIX:-$PREREQ_INSTALL_ROOT/blas}
export ZLIB_INSTALL_PREFIX=${ZLIB_INSTALL_PREFIX:-$PREREQ_INSTALL_ROOT/zlib}
export OPENSSL_INSTALL_PREFIX=${OPENSSL_INSTALL_PREFIX:-$PREREQ_INSTALL_ROOT/openssl}
export CURL_INSTALL_PREFIX=${CURL_INSTALL_PREFIX:-$PREREQ_INSTALL_ROOT/curl}
export AWS_INSTALL_PREFIX=${AWS_INSTALL_PREFIX:-$PREREQ_INSTALL_ROOT/aws}
